...
require (
	...
	// ponytail: newer PacketFence releases no longer contain go/sharedutils.
	github.com/inverse-inc/packetfence v0.0.0-20190923130955-9b9996e89548
	// ponytail: newer golongpoll needs a cluster observer client API migration.
	github.com/jcuga/golongpoll v1.1.1-0.20180711123949-939e3befd837
	// ponytail: stay on Stripe 28.x until billing and webhook APIs are migrated.
	github.com/stripe/stripe-go v28.12.0+incompatible
